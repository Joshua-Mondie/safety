...
const Header = () => {
	return (
		<div className=" md:w-full z-20 fixed  ">
			{/* <div className="  h-[1rem]"> */}
				{/* <div className="hidden  w-full  h-[3rem] bg-gray-100 md:flex items-center justify-between md:pl-16 pr-8 ">
				...
				<div className="hidden shadow-lg h-[6rem] md:flex gap-10  bg-white py-2  sticky">
					...
					<div className="w-4/5 flex gap-x-14 items-center  dropdown">
									...
									<div
										className={` ${
											index === navLinks.length - 3
												? "absolute w-[20rem]  z-50 text-black  mt-[20rem] pt-4 -ml-40 hidden bg-white group-hover:block shadow-lg"
