...
const MembershipFee = () => {
  ...
  return (
    <div className="grid">
      <div className="mb-20">
        <div
          className=" h-[30rem]  bg-cover membershipfeesbg"
      ...
      <div className="mt-40 mb-40">
        ...
        <div className="pl-96 mt-20">
          ...
          <div className="flex gap-x-10 mb-40">
            ...
            <p className="font-custom text-gray-500">
              <span className="text-xl text-green-600">Account Number:</span>{" "}
              1225579797
            </p>
            <p className="font-custom text-gray-500">
              <span className="text-xl text-green-600">Name:</span> Institute of
              Safety Professionals of Nigeria
            </p>
          </div>
