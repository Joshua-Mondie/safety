              ...
              <div className="mt-20 px-24  ">
                ...
                <div className="grid grid-cols-3 gap-x-5 gap-y-8   ">
                  {individual.content.map((innercontent, childIndex) => (
                    <div
                      key={childIndex}
                      className="  shadow-md bg-green-600 pt-5 shadow-gray-300 rounded-md justify-center w-[25rem] h-[17rem]"
                    >
        ...
        <div className="mt-40 px-40">
          {individualMembershipRequirements.map((member, index) => (
            <div key={index} className="">
              <div className="  justify-center flex mb-10 text-2xl font-custom">{member.header}</div>
